<?php
	...
	*/
        ...
        eZSys::init( 'index_gateway.php', $ini->variable( 'SiteAccessSettings', 'ForceVirtualHost' ) == 'true' );
        // eZSys::initIni( $ini );
        ...
        // die( $ini->variable( 'SiteSettings', 'DefaultAccess' ) );
	...
	include "extension/remoting/lib/amfphp/globals.php";

	//Include framework
	include "extension/remoting/lib/amfphp/core/amf/app/Gateway.php";
