...

{
	...
	private var gatewayUrl:String = "http://<?php echo $info['server'] ?>/flashservices/gateway.php";
	private var service:Service;

	function <?php echo $info['class'] ?>(<?php if($info['auth']){ echo ("user, pass"); } ?>)
	{
		NetDebug.initialize();
		this.service = new Service(this.gatewayUrl, null, "<?php echo $info['package'] . $info['class'] ?>", null, null);
