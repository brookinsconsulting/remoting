<?php
	...
	$amfphp['startTime'] = ((float)$usec + (float)$sec);
        ...
        /*
	$servicesPath = "extension/remoting/lib/amfphp/services/";
	$voPath = "extension/remoting/lib/amfphp/services/vo/";
	*/

	$servicesPath = "extension/remoting/services/";
	$voPath = "extension/remoting/services/vo/";
